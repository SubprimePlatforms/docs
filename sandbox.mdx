...
Endpoints outside of sessions, financial, workflows, and credit-checks (e.g., `/health`) pass through normally. The [iGaming checks](/igaming/overview) (`/v1/igaming/*`) have no sandbox fixtures, and because sandbox keys can't create sessions they are effectively unavailable in sandbox — use a live key with a test workflow.
...
<CardGroup cols={2}>
  ...
  <Card title="Sandbox Models" icon="flask-conical" href="/api-reference/sandbox/models">
