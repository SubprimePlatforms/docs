...
<FeatureGrid cols={2}>
  ...
  <FeatureCard icon="share-2" title="Send via any channel" description="Deliver links through email, SMS, WhatsApp, support chat, in-app messages, or embed directly on your site." />

  <FeatureCard icon="qr-code" title="Works in-person too" description="Generate a QR code for walk-in scenarios where applicants need to verify on their own device." />
</FeatureGrid>
