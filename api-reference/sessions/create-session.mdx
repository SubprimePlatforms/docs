...
| `profile_id`        | `profileId`       | string  | No       | ID of a branding profile to use for this session's applicant-facing page. If omitted, default branding is used |
...
| `403 Forbidden`         | profile_id belongs to a different organization                |
| `404 Not Found`         | profile_id doesn't exist (message: "Profile not found")       |
