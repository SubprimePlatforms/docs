---
title: Introduction
description: The New Standard of Verification for Humans + AI
---
...
<FeatureGrid cols={2}>
  <FeatureCard icon="venetian-mask" title="Blind to modern fraud vectors" description="Legacy pipelines weren't built to catch deepfakes, synthetic IDs, or AI-generated documents." />
  ...
  <FeatureCard icon="boxes" title="All-or-nothing packages" description="Forced into monolithic KYC bundles when you only need a liveness check or a document scan." />
</FeatureGrid>
...
<SectionHeader
  ...
  title={
    <>
      One platform for <span>Identity, Fraud and Compliance</span>
    </>
  }
/>

<VideoEmbed
  src="https://www.youtube.com/embed/kxCRwBm9lBw?rel=0&playsinline=1"
  title="deepidv Platform Overview"
/>

deepidv is a **modular, API-first compliance and verification platform** — built to give developers full control over what they verify, how they verify it, and what they pay.
...
<FeatureGrid cols={2}>
  <FeatureCard icon="puzzle" title="Fully Modular" description="Compose verification flows from individual services — ID checks, liveness, AML screening, financial data — and nothing you don't need." />
  ...
  <FeatureCard icon="banknote" title="Transparent Pay-Per-Use" description="Published rates for every service. Top up tokens, pay only for completed checks. No contracts or minimums." />

  <FeatureCard icon="trending-up" title="Scales With You" description="The same platform works whether you're running 10 verifications a month or 10,000 a day." />
...
<FeatureGrid cols={3}>
  ...
  <FeatureCard icon="cake" title="Age Verification" description="Confirm user age for regulated content, products, or services using AI-powered age estimation." />
  ...
  <FeatureCard icon="landmark" title="Financial Data Aggregation" description="Pull bank statements and run AI-driven analysis for credit decisions, affordability checks, and underwriting." />

  <FeatureCard icon="workflow" title="Custom Verification Workflows" description="Chain multiple checks into reusable workflows — trigger them via API or shareable verification links." />
</FeatureGrid>
...
<CardGroup cols={2}>
  ...
  <Card title="Explore All Services" icon="layout-grid" href="/services">
