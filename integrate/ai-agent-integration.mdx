...
<CardGroup cols={2}>
  <Card title="Agent Skills Repository" icon="git-fork" href="https://github.com/Deep-Identity-Inc/agent-skills">
...
<Card title="API Authentication" icon="key" href="/authentication">
  ...
  <Card title="Support" icon="life-buoy" href="https://www.deepidv.com/support">
