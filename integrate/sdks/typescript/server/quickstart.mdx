...
<CardGroup cols={2}>
  ...
  <Card title="Configuration" icon="settings" href="/integrate/sdks/typescript/server/configuration">
  ...
  <Card title="Error Handling" icon="triangle-alert" href="/integrate/sdks/typescript/server/error-handling">
